...
//
//     plutil -convert json -r -o $GOPATH/src/github.com/jgulick48/hc/gen/metadata.json /Applications/HomeKit\ Accessory\ Simulator.app/Contents/Frameworks/HAPAccessoryKit.framework/Versions/A/Resources/default.metadata.plist
package main

import (
	"encoding/json"
	"github.com/jgulick48/hc/gen"
	"github.com/jgulick48/hc/gen/golang"
	"io/ioutil"
	"log"
	"os"
	"os/exec"
